      ...
      return (
          <div>
            ...
            <div className={"sidebar " + ((this.state.currentTab == 2) ? 'active' : '')}>
              <InputPanel data={this.state.data} onDataChange={this.onDataChange} onDeleteClick={this.onDeleteClick} onHeaderChange={this.onHeaderChange} />
            </div>
            ...
            <PreviewPanel data={this.state.data} showOrder={this.state.showOrder} />
