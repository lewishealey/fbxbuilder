...
module.exports = React.createClass({
    ...
    <tr>
        <td bgcolor="#EFEFEF" align="center" className="slice-padding" style={{padding: "0px 15px 0px 15px"}}>
                                        ...
                                        <tr>
                                            <td>
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="center" bgcolor="#FFFFFF" valign="middle" style={{position: "relative"}}>
                                                            <a href={this.props.inputs[0].link + "?itc=" + this.props.itc + "&utm_source=newsletter&utm_medium=email&utm_campaign=" + this.props.campaign + "&src_t=nwt&src_id=" + this.props.id + "&via=NL_row&NL_pos=" + this.props.order} target="_blank">
                                                                <img src={this.props.inputs[0].image} width="600" style={{display: "block", width: "600px"}} alt={this.props.inputs[0].title} title={this.props.inputs[0].title} border="0" className="img-max" />
